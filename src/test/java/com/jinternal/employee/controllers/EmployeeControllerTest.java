...
import com.jinternal.employee.utils.PageUtils;
...
public class EmployeeControllerTest {
    ...
    public void shouldRegisterEmployee() throws Exception {
        ...
        when(employeeService.saveEmployee(Mockito.any())).thenReturn(anEmployee(1L, "Mradul", "Pandey"));
    ...
    public void shouldUpdateEmployee() throws Exception {
        ...
        when(employeeService.updateEmployee(Mockito.any())).thenReturn(anEmployee(1L, "mradul", "pandey"));
    ...
    public void shouldGetAllTheEmployee() throws Exception {
        ...
        when(employeeService.getAllEmployee(Mockito.any())).thenReturn(employeePage);
